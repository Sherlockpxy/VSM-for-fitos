...
class SchedulerAPI(vsm.openstack.common.rpc.proxy.RpcProxy):
    ...
    def add_server_fh(self, ctxt, body=None):
        #NOTE change this procedure to rpc.cast method()
        ret = self.cast(ctxt, self.make_msg('add_server_fh', body=body))
        return ret
    ...
    def get_available_physical_disks(self, ctxt, body=None):
        return self.call(ctxt, self.make_msg('get_available_physical_disks', body=body))
    ...
    def add_batch_new_physical_disks_to_cluster(self, ctxt, body=None):
        return self.call(ctxt, self.make_msg('add_batch_new_physical_disks_to_cluster', body=body))
