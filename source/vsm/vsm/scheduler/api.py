...
class API(object):
    ...
    def add_server_fh(self, context, body=None):
        return self.scheduler_rpcapi.add_server_fh(context, body)
    ...
    def get_available_physical_disks(self, context, body=None):
        return self.scheduler_rpcapi.get_available_physical_disks(context, body)
    ...
    def add_batch_new_physical_disks_to_cluster(self, context, body=None):
        return self.scheduler_rpcapi.add_batch_new_physical_disks_to_cluster(context, body)
