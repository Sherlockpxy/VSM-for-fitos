...
from .views import get_available_physical_disks,check_physical_device_path,add_new_osd_action_fh
...
urlpatterns = patterns('',
    ...
    url(r'^get_available_physical_disks/$', get_available_physical_disks, name='get_available_physical_disks'),
    url(r'^check_physical_device_path/$', check_physical_device_path, name='check_physical_device_path'),
    url(r'^add_new_osd_action_fh/$', add_new_osd_action_fh, name='add_new_osd_action_fh'),
