...
from .tables import AddServerTableFh
...
class AddServersView(tables.DataTableView):
    ...
    table_class = AddServerTableFh
    verbose_name = "Add Servers"
	#template_name = 'vsm/storageservermgmt/serversaction.html'
    template_name = 'vsm/storageservermgmt/serversaction_fh.html'
...
def add_server_fh(request):
    data = json.loads(request.body)
    print "=============Add Server======================"
    print data
    code,ret = vsmapi.add_servers_fh(request, data)
    print ret
