...
def add_servers_fh(request, servers=[]):
    return vsmclient(request).servers.add_servers_fh(servers)
...
def add_batch_new_physical_disks_to_cluster(request, body):
    return vsmclient(request).osds.add_batch_new_physical_disks_to_cluster(body)

def get_available_disks(request,  search_opts):
    return vsmclient(request).devices.get_available_disks( search_opts=search_opts)

def get_available_physical_disks(request,  search_opts):
    return vsmclient(request).devices.get_available_physical_disks( search_opts=search_opts)
